...
from urllib.parse import quote_plus  # Importing quote_plus for URL encoding
...
MONGO_URI = f"mongodb+srv://Telegram_aibot:{encoded_password}@cluster0.daga7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
async def web_search(client: Client, message: Message):
    ...
    try:
        ...
        response.raise_for_status()  # This will raise an error if status code is not 200
